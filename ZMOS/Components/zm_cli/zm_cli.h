...
#define CLI_VERSION_STRING      STRINGIFY(CLI_PRIMAIRE_VERSION.CLI_SUB_VERSION.CLI_REVISED_VERSION)
...
typedef enum
{
    ZM_PRINT_VT100_COLOR_DEFAULT,
    ZM_PRINT_VT100_COLOR_BLACK,
    ZM_PRINT_VT100_COLOR_RED,
    ZM_PRINT_VT100_COLOR_GREEN,
    ZM_PRINT_VT100_COLOR_YELLOW,
    ZM_PRINT_VT100_COLOR_BLUE,
    ZM_PRINT_VT100_COLOR_MAGENTA,
    ZM_PRINT_VT100_COLOR_CYAN,
    ZM_PRINT_VT100_COLOR_WHITE,
